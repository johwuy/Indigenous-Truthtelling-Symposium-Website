export const Team = [
    {
        name: "Shaheen Nassar",
        description: "Shaheen Nassar is a Palestinian organizer, freelance journalist, and public scholar whose work focuses on decolonization, abolitionist praxis, and global struggles against racialized state violence. He holds a Bachelor of Arts in Ethnic Studies, a foundation that informs his interdisciplinary approach to political education and critical analysis. His published writings include “The ‘war on terror’ is a noose around Black America’s neck” (Al Jazeera), “Of Muslims and men: Monsterising the racial other” (Al Jazeera), and “Zionism’s problem with intersectionality” (Al Jazeera). As a longtime movement educator and former member of the Irvine 11, Shaheen’s political development has been shaped by nearly fifteen years of campus organizing, public-facing political education, and community documentation. His current work explores Palestinian liberation, political memory, and the cultural logics of anti-colonial resistance across diasporic contexts.",
    },
    {
